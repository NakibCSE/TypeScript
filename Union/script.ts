...
let n: number | string = 10; // here | is using as a union operator, it means the variable can hold both number and string
console.log(n);
n = "Mr. Khan";
console.log(n);
...
function display2(param: string | number | boolean) {
  console.log(param);
